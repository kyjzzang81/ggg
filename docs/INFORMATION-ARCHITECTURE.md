...
|---|---|---|---|
| Mobile (≤767px) | 고정 노출 5탭 | 햄버거 메뉴 드로어 | 사이드바 `모드 설정` 섹션 |
| Tablet (768~1023) | 숨김 | 좌측 72px 아이콘 | 사이드바 `모드 설정` 섹션 |
| Desktop (≥1024) | 숨김 | 좌측 240px 풀 라벨 | 사이드바 `모드 설정` 섹션 |
